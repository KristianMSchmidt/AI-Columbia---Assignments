"""
K-nearest neighbors classification using Sklearn
...
parameters = [{'n_neighbors': range(1,51), 'leaf_size': [5*n for n in range(1, 13)]}]
neigh = KNeighborsClassifier()
clf = GridSearchCV(neigh, parameters, cv = 5) #CV is number of (stratisfied ) folds in k-fold cross val
