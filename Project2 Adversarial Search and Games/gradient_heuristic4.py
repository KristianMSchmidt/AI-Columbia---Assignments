"""
Same as parent - just with different length table - trying to obtain more zeros.

Test1: 2048 ("problem is that small values tend to get trapped in corner. Solution could be more smooth scaling
              Especially, this the tile with distance sqrt(2) to corner should be worht more... to make whole
              corner region more flexible")
Test2: 2048... this is good!
...
LL = {(0,0):v4,    (0,1):v5,   (0,2):v6,    (0,3):v7,
      ...
      (2,0):v2,    (2,1):v3,   (2,2):v3,    (2,3):v5,  #bemaerl fejl
